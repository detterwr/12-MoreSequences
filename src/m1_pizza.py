...
def run_test_draw_points_on_circle():
    ...
    title = 'DRAW_POINTS_ON_CIRCLE, test 2:  3 green dots.'
...
def run_test_polygon():
    ...
    polygon(window1, circle, 2, 'red', 12)
    window1.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    window = rg.RoseWindow(500, 475)
    circle = rg.Circle(rg.Point(250, 200), 175)
